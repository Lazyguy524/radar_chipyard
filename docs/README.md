...
| Scalar-vs-RoCC cycle profile | PASS in one board run after reset; scalar QMLP `168203` cycles avg, RoCC `rqdot4` QMLP `62532` cycles avg, `speedup_x1000=2689` (~2.689x). | [xradar-rocc-cycle-profile-75mhz-2026-06-09-2026-06-09-215919.log](/home/soooarr/chipyard/logs/radar_nexysvideo/runtime/xradar-rocc-cycle-profile-75mhz-2026-06-09-2026-06-09-215919.log), [radar-xradar-rocc-cycle-profile-2026-06-09.riscv](/home/soooarr/chipyard/logs/radar_nexysvideo/runtime/xradar-dot4-2026-06-09/artifacts/radar-xradar-rocc-cycle-profile-2026-06-09.riscv) |

Current RoCC boundary: `rqdot4` has board functional evidence and a first scalar-vs-RoCC cycle result on the timing-clean bitstream. Memory-smoke and printable smoke both validate 4 basic dot4 cases and 8 QMLP semantic cases, and the one-run profile shows about `2.689x` QMLP-kernel speedup for the RoCC-dot4 path in this test. `rqscale8`, `rqpack`, and `racc.*` remain unimplemented in RoCC RTL.
