<!-- weekly-report-20260918 -->
2026-09-18组会准备：[本周完整周报与5分钟汇报](weekly_report_2026-09-18/README.md)。统计截至9月17日，用户选5分钟、5页；含完整周报、逐页讲稿、老师追问、中文代表图/CSV和Windows端PPT生成Prompt。本次只汇报数据复现、特征增减和阶段取舍，Gemmini/PMU/详细推导留后续专题；局部回退和独立确认缺口仍在正文说明。本包只整理汇报，不新增训练或硬件工作。

<!-- feature-dimension-sweep-20260917 -->
2026-09-17 最新软件实验：[8～36维双向实验与收敛](feature_dimension_sweep_2026-09-17/README.md)，先读[白话解释](feature_dimension_sweep_2026-09-17/02_白话解释与收敛判断.md)。按用户要求向上增维、向下删维，完成11组×三个种子＝33条新训练，复用六个16/23维模型。所测8/12/15维退化；23维综合96.960%，24维96.966%，最高四分位宽度28维97.060%，32/36维未形成稳定替代优势。维度选型仍保留23维软件候选，旧A主/B困难备选保持。必须披露：24维单独通过旧A/B门槛，但未过本轮最小增益要求；旧116条紧凑少点组相对A仍净多错3/4/0条，一个种子打平仅避免旧的三种子一致退步否决，不能宣称局部问题解决，详见[门槛敏感性](feature_dimension_sweep_2026-09-17/10_门槛敏感性与最终评审.md)。新增分位组在N1/N2不增加独立信息，N3还有重复项，全部真实视图逐整数核验；该结论限定本轮定义。33新模型完整C点到logits共9,105,294次零差异，585组指标重算通过，旧七包SHA及原HEAD/index保持。主线不变，继续暂停新增硬件，独立泛化与实际板级收益另列；不宣称全局最优维数。Git侧分支与Obsidian本地镜像状态见包内收据。此前各阶段的规则及失败证据原样保留。

<!-- feature-enrichment-20260917 -->
2026-09-17 最新软件实验：[可解释特征补充与维度扩展](feature_enrichment_2026-09-17/README.md)，白话先读[实际说明](feature_enrichment_2026-09-17/08_白话解释与数据观察.md)。按用户要求允许增加维度，完成16/19/20/23维五组×三个种子的15条固定训练；含只重复旧信息的等维23对照。几何与速度/RCS两组联合补充的23维通过相对16维全部新增要求，综合96.763%→96.960%（+0.197pp），常规98.143%→98.491%；真实少点当前帧仍下降0.266pp，需披露。相对旧A仍有一个116条/19序列的紧凑少点组下降2.586pp，保留A主/B备及23维软件候选，不称全面替代。网络MAC3136→3584，新增每点5乘积和每簇7有理数量化；无FPGA收益结论。15模型完整点到logits共4,138,770次零差异，提供分布图、同旧表示反例、低点数退化推导与全部失败组。主线和独立泛化缺口保持，暂停新增硬件；下一待解机制为低点数编码与形态描述的混杂，尚未追加该训练。旧阶段内容与结论原样保留。

<!-- feature-ablation-20260917 -->
2026-09-17 最新软件实验：[特征必要性与删组重训](feature_ablation_2026-09-17/README.md)。已完成21/20/18/16维×三个种子的12条匹配训练。去重复20维和去部分形态代理16维通过相对本轮21维对照的删维容忍度；按预设规则选16维作为真实少点覆盖下的简化候选。去RCS18维明显退化，保留RCS。16维综合96.763%、常规98.143%，网络MAC从3456降至3136；这是软件运算计数，非FPGA收益。16维仍未过旧A/B的全部推广门槛（中心删点、一个紧凑组），整体保留A主基线/B困难备选。12模型完整点到logits共3,311,016次核对零差异。继续暂停新增硬件；旧文档中的“删维未做”是历史阶段状态，以本入口为准。研究主线与独立泛化缺口保持。
