...
REF='refs/heads/backup/radar-thesis-20260917-software'
PACKAGES=['software_convergence']
...
def main():
    ...
    paths.add(LOG/'data/matching.json')
    ...
    with tempfile.TemporaryDirectory(prefix='radar_software_git_') as temporary:
        ...
        subprocess.run(['git','read-tree',old or 'ffb9f1c9260212ab5f5867a8207c366ef2b160ec'],cwd=ROOT,env=env,check=True)
        entries=[]
        ...
        commit=git(['commit-tree',tree,'-p',old or 'ffb9f1c9260212ab5f5867a8207c366ef2b160ec'],input=message,text=True).strip()
    ...
    bundle_path=bundle/('software_convergence_'+a.phase+'.bundle')
