...
REF='refs/heads/backup/radar-thesis-20260917-feature-ablation'
PACKAGES=['feature_ablation']
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='radar_software_git_') as temporary:
        ...
        subprocess.run(['git','read-tree',old or '152a4bf9cecdbee1120b9593f0e2d850dd18805b'],cwd=ROOT,env=env,check=True)
        entries=[]
        ...
        commit=git(['commit-tree',tree,'-p',old or '152a4bf9cecdbee1120b9593f0e2d850dd18805b'],input=message,text=True).strip()
    ...
    bundle_path=bundle/('feature_ablation_'+a.phase+'.bundle')
