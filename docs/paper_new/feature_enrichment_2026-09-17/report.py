...
def main():
    ...
    metrics=json.loads((LOG/'evaluation/metrics.json').read_text());m={(r['tag'],r['seed'],r['condition']):r for r in metrics};ci=readcsv(LOG/'evaluation/paired_sequence_intervals.csv');names={'A':'旧A主基线','B':'旧B困难备选','base16':'16维对照','geometry19':'19维：补充几何分布','distribution20':'20维：补充速度/RCS分布','combined23':'23维：两组都加','redundant23':'23维：只重复旧信息'}
