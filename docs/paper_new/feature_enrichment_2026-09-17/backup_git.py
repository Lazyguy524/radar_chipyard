...
REF='refs/heads/backup/radar-thesis-20260917-feature-enrichment'
PACKAGES=['feature_enrichment']
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='radar_software_git_') as temporary:
        ...
        subprocess.run(['git','read-tree',old or '17869b6d5a01f2b7ea78a5c34f646c311027d7cf'],cwd=ROOT,env=env,check=True)
        entries=[]
    ...
    bundle_path=bundle/('feature_enrichment_'+a.phase+'.bundle')
